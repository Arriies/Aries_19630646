...
public class tbl_arsip {
    ...
    private Date tanggal_sj;

    public tbl_arsip(int no_sj, int no_order, int id_costumer, Date tanggal_sj) {
        this.no_sj = no_sj;
    ...
    public Date gettanggal_sj() {
        return tanggal_sj;
    }

    public void settanggal_sj(Date tanggal_sj) {
        this.tanggal_sj = tanggal_sj;
    }
}
